...
<body>
    ...
    <p>Nossos profissionais de limpeza irão cuidar de todas as suas necessidades de limpeza doméstica, deixando sua casa brilhando.</p>

    <h2>Limpeza Profunda</h2>
    <img src="caminho_para_sua_imagem" alt="Imagem do serviço de Limpeza Profunda">
    <p>Este serviço é perfeito para a primavera ou para uma limpeza profunda ocasional. Inclui tudo na limpeza geral e mais.</p>
